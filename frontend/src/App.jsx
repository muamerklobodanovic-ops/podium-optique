...
// --- VERSION APPLICATION ---
const APP_VERSION = "3.42"; // Fix ReferenceError (Brands Order)
...
function App() {
  ...
  // --- LISTES DE RÉFÉRENCE (PLACÉES AVANT LES FONCTIONS QUI LES UTILISENT) ---
  ...
  // --- LOGIQUE DE FILTRAGE DES MARQUES ---
